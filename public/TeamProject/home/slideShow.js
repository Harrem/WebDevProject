...
//       const movie = `<div class="carousel-cell" style="margin: 10px; height:600px ; width: 90%; background-color: black;" id="" >
//           <img id="topimg" class="backgroundImage" src="${backdrop}" alt="cover image">
//           <img src="${poster}" alt="" id="poster">
//           <div id="container">
//               <div id="textContainer">
//                   <h1 id="title">${title}</h1>
